...
/**
 * Configuration class for paginated menu inventories in Minecraft.
 * This class handles the layout and appearance settings for paginated menus.
 */
    ...
    public ValidationResult validate() {
        if (inventorySize < (itemRowsPerPage + 1) * ROW_SIZE)
            return ValidationResult.error(
                    "Inventory size must be at least " + ((itemRowsPerPage + 1) * ROW_SIZE)
